$js.compile("$css", null, function ($public, $private, $protected, $self) {
    ...
    $public.func.builder = function (o) {

        return {
            commitAll: function () {

                let css = JSON.stringify(o.json)
                    .replaceAll(",", ";")
                    .replaceAll("<>", ",")
                    .replaceAll("\"", "")
                    .replace("}", "")
            ...
            save: function () {
                ...
                for (let key in o.json) {
                    json += key + ": " + o.json[key] + "; ";
                }

                json += "}";

                let css = o.selector + o.clss + " " + json;
            ...
            widthFromViewportWidth: function (vw) {
                o.json.width = vw + "vw";
                return this;
            },
            ...
            heightFromViewportHeight: function (vh) {
                o.json.height = vh + "vh";
                return this;
            },
            side: function (px) {
            ...
            topFromViewportHeight: function (vh) {
                o.json.top = vh + "vh";
                return this;
            },
            middle: function (px) {
            ...
            marginRightPercent: function (p) {
                o.json["margin-right"] = p + "%";
                return this;
            },
            ...
            marginBottomPercent: function (p) {
                o.json["margin-bottom"] = p + "%";
                return this;
            },
            ...
            marginHorizontalPercent: function (p) {
                o.json["margin-left"] = p + "%";
                o.json["margin-right"] = p + "%";
                return this;
            },
            ...
            paddingLeftPlain: function (p) {
                o.json["padding-left"] = p;
                return this;
            },
            ...
            paddingRightPlain: function (p) {
                o.json["padding-right"] = p;
                return this;
            },
            ...
            textWeight: function (w) {
                o.json["font-weight"] = w;
                return this;
            },
